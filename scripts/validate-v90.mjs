...
if (isV92 && hasV93Overlay && (!home.includes('本站 7.2d 標準 ARAM 全量校正') || !home.includes('v93'))) errors.push('homepage v93 overlay missing');
if (isV92 && !hasV93Overlay && (!home.includes('本站 7.2d 版本沉澱校正') || !home.includes('v92'))) errors.push('homepage v92 panel missing');
