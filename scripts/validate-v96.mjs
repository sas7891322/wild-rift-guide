...
const report = read('assets/data/calibration-7.2e-v96.json');
expect(patchData.version === '7.2e' && patchData.siteVersion === 'v96', 'Current patch mismatch');
...
console.log(JSON.stringify({version:'v96',riftProfiles:202,aramProfiles:141,aaaProfiles:140,structureAndReferences:'PASS',protectedFiles:'PASS',officialDelta:'PASS'},null,2));
