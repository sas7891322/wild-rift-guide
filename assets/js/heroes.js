  ...
  async function init(){
    ...
    try{
      const [heroData,runeData,itemData,spellData]=await Promise.all([
        getJSON('../assets/data/heroes.json?v=79.3'), getJSON('../assets/data/runes.json?v=79.3'), getJSON('../assets/data/items.json?v=79.3'), getJSON('../assets/data/spells.json?v=79.3')
      ]);
